			       ...
			       void __user *dst, snd_pcm_uframes_t count)
{
	...
	PRINTK_AUD_DAI("mtk_bt_dai_pcm_copy finish0, read_count:0x%x, read_size:0x%x, u4DataRemained:0x%x,
		u4DMAReadIdx:0x%x, u4WriteIdx:0x%x \r\n", read_count, read_size, Dai_Block->u4DataRemained,
		Dai_Block->u4DMAReadIdx, Dai_Block->u4WriteIdx);
	...
	if (DMA_Read_Ptr + read_size < Dai_Block->u4BufferSize) {
		...
		PRINTK_AUD_DAI("mtk_bt_dai_pcm_copy finish1, copy size:0x%x, u4DMAReadIdx:0x%x, u4WriteIdx:0x%x,
		...
		PRINTK_AUD_DAI
		    ("mtk_bt_dai_pcm_copy finish2, copy size_1:0x%x, u4DMAReadIdx:0x%x, u4WriteIdx:0x%x,
		...
		PRINTK_AUD_DAI("mtk_bt_dai_pcm_copy finish3, copy size_2:0x%x, u4DMAReadIdx:0x%x,
			u4WriteIdx:0x%x u4DataRemained:0x%x \r\n", size_2, Dai_Block->u4DMAReadIdx,
