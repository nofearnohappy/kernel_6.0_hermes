				 ...
				 void __user *dst, snd_pcm_uframes_t count)
{
	...
	PRINTK_AUD_UL2("mtk_capture2_pcm_copy finish0, read_count:%zu, read_size:%zu, u4DataRemained:%x,
		u4DMAReadIdx:0x%x, u4WriteIdx:%x \r\n", read_count, read_size, Vul_Block->u4DataRemained,
		Vul_Block->u4DMAReadIdx, Vul_Block->u4WriteIdx);
	...
	if (DMA_Read_Ptr + read_size < Vul_Block->u4BufferSize) {
		...
		PRINTK_AUD_UL2("mtk_capture2_pcm_copy finish1, copy size:%zu, u4DMAReadIdx:0x%x, u4WriteIdx:%x,
		...
		PRINTK_AUD_UL2("mtk_capture2_pcm_copy finish2, copy size_1:%x, u4DMAReadIdx:0x%x, u4WriteIdx:0x%x,
		...
		PRINTK_AUD_UL2("mtk_capture2_pcm_copy finish3, copy size_2:%x, u4DMAReadIdx:0x%x,
