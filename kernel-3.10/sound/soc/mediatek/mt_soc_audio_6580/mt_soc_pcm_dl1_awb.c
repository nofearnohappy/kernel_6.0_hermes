				...
				void __user *dst, snd_pcm_uframes_t count)
{
	...
	PRINTK_AUD_AWB("mtk_dl1_awb_pcm_copy, Awb_Block = %p AudDrv_MEMIF_Read finish0, count:0x%x, read_size:0x%x,
		u4DataRemained:0x%x, u4DMAReadIdx:0x%x, u4WriteIdx:0x%x \r\n", Awb_Block, count, read_size,
		Awb_Block->u4DataRemained, Awb_Block->u4DMAReadIdx, Awb_Block->u4WriteIdx);
	...
	if (DMA_Read_Ptr + read_size <= Awb_Block->u4BufferSize) {
		...
		PRINTK_AUD_AWB("mtk_dl1_awb_pcm_copy finish1, copy size:0x%x, u4DMAReadIdx:0x%x, u4WriteIdx:0x%x,
			u4DataRemained:0x%x u4MaxCopySize:0x%x\n", read_size, Awb_Block->u4DMAReadIdx,
		...
		PRINTK_AUD_AWB("mtk_dl1_awb_pcm_copy finish2, copy size_1:0x%x, u4DMAReadIdx:0x%x, u4WriteIdx:0x%x,
			u4DataRemained:0x%x \r\n", size_1, Awb_Block->u4DMAReadIdx, Awb_Block->u4WriteIdx,
		     Awb_Block->u4DataRemained);

		if (DMA_Read_Ptr != Awb_Block->u4DMAReadIdx) {

			PRINTK_AUD_AWB("mtk_dl1_awb_pcm_copy 3, read_size2:%x, DataRemained:%x, DMA_Read_Ptr:0x%x,
		...
		PRINTK_AUD_AWB("mtk_dl1_awb_pcm_copy finish3, copy size_2:0x%x, u4DMAReadIdx:0x%x,
