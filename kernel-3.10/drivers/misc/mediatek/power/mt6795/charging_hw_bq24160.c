...
static kal_uint32 charging_hw_init(void *data)
{
    ...
    battery_log(BAT_LOG_FULL,"[charging_hw_init] From Tim\n");
...
static kal_uint32 charging_get_charger_det_status(void *data)
{
    ...
    pmic_read_interface(0x108,   &val,0x1, 1);
    *(kal_bool*)(data) = val;
    battery_log(BAT_LOG_FULL,"[charging_get_charger_det_status] CHRDET status = %d\n", val);
#else
...
static kal_uint32 charging_set_power_off(void *data)
{
    ...
    battery_log(BAT_LOG_CRTI, "charging_set_power_off=%d\n");
    mt_power_off();
