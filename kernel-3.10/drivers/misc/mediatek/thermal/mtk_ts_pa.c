...
extra_thermal_zone_register(void)
{
	mtktspa_dprintk("%s doesn't exist\n", __func__);
}

void __attribute__((weak))
extra_proc_register(void)
{
	mtktspa_dprintk("%s doesn't exist\n", __func__);
}

void __attribute__((weak))
extra_thermal_zone_unregister(void)
{
	mtktspa_dprintk("%s doesn't exist\n", __func__);
}
//************************************
