...
INT32 i4VDEC_HAL_WMV_DecStart(UINT32 u4VDecID, VDEC_INFO_DEC_PRM_T *prDecPrm)
{
    ...
    vVDecWriteMC(u4VDecID, RW_MC_PP_ENABLE, 0x00000001);
    {
        ...
        vVDecWriteUFO(u4VDecID, 31*4, PHYSICAL((UINT32) u4YStartAddr) + prDecPrm->u4PIC_SIZE_BS);//698*4 = 0xAE8
        vVDecWriteUFO(u4VDecID, 32*4, PHYSICAL((UINT32) u4YStartAddr) + prDecPrm->u4PIC_SIZE_BS + prDecPrm->u4UFO_LEN_SIZE_Y);//699*4 = 0xAEC
        #endif
    ...
    if ((prWmvDecPrm->prPPS->ucPicType == BVOP) || (prWmvDecPrm->prPPS->ucPicType == BIVOP)) //prog_B
    {
        ...
        vVDecWriteUFO(u4VDecID, 33*4, (u4AbsDramANc((ULONG) prWmvDecPrm->rWmvWorkBufSa.u4Pic2YSa) >> prWmvDecPrm->i4MemBase) >> 9);
        vVDecWriteUFO(u4VDecID, 34*4, (u4AbsDramANc((ULONG) prWmvDecPrm->rWmvWorkBufSa.u4Pic2CSa) >> prWmvDecPrm->i4MemBase) >> 8);
        #endif
#endif
    }
    else if (prDecPrm->ucDecFBufIdx == 0) //pic1
    {
        ...
        #if (VDEC_UFO_SUPPORT && (CONFIG_CHIP_VER_CURR >= CONFIG_CHIP_VER_ROCKY))
        vVDecWriteUFO(u4VDecID, 33*4, (u4AbsDramANc((ULONG) prWmvDecPrm->rWmvWorkBufSa.u4Pic0YSa) >> prWmvDecPrm->i4MemBase) >> 9);
        vVDecWriteUFO(u4VDecID, 34*4, (u4AbsDramANc((ULONG) prWmvDecPrm->rWmvWorkBufSa.u4Pic0CSa) >> prWmvDecPrm->i4MemBase) >> 8);
        #endif
#endif
    }
    else //pic2
    {
        ...
        #if (VDEC_UFO_SUPPORT && (CONFIG_CHIP_VER_CURR >= CONFIG_CHIP_VER_ROCKY))
        vVDecWriteUFO(u4VDecID, 33*4, (u4AbsDramANc((ULONG) prWmvDecPrm->rWmvWorkBufSa.u4Pic1YSa) >> prWmvDecPrm->i4MemBase) >> 9);
        vVDecWriteUFO(u4VDecID, 34*4, (u4AbsDramANc((ULONG) prWmvDecPrm->rWmvWorkBufSa.u4Pic1CSa) >> prWmvDecPrm->i4MemBase) >> 8);
        #endif
#endif
    }
