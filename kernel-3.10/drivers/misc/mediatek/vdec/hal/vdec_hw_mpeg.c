...
void vVDecWriteMP4AVCMV(UINT32 u4VDecID, UINT32 u4Addr, UINT32 u4Val);
UINT32 u4VDecReadMP4AVCMV(UINT32 u4VDecID, UINT32 u4Addr);
...
void vVLDDoDec(UINT32 u4VDecID, VDEC_INFO_DEC_PRM_T *prDecPrm, BOOL fgBPic, BOOL fgB21FrmPic)
{
    ...
    if (_u4CodecVer[u4VDecID] == VDEC_MPEG4 || _u4CodecVer[u4VDecID] == VDEC_H263 || _u4CodecVer[u4VDecID] == VDEC_DIVX3 || _u4CodecVer[u4VDecID] == VDEC_S263)
    {
...
void vVLDM4vDecPrmProc(UINT32 u4VDecID, VDEC_INFO_DEC_PRM_T *prDecPrm)
{
    ...
    if ((_u4CodecVer[u4VDecID] == VDEC_MPEG4) || (_u4CodecVer[u4VDecID] == VDEC_H263) || (_u4CodecVer[u4VDecID] == VDEC_S263))
    {
        if (bMode_Divx[u4VDecID])
        {
    ...
    else if (_u4CodecVer[u4VDecID] == VDEC_DIVX3)
    {
        u4RegVal1 |= (0x1 << 16) | (0x1 << 9); // bit 9 is DIVX mode flag
    }
    else
    {
        printk("vVLDM4vDecPrmProc unexpected format , something wrong");
    }
    ...
    //6589NEW 4.5 - 4.12
    vVDecWriteMP4AVCMV(u4VDecID, RW_AMV_MP4_VTRBD, (prDirMdPrm->u4Trb << 16) | (prDirMdPrm->u4Trd & 0xFFFF));
    vVDecWriteMP4AVCMV(u4VDecID, RW_AMV_MP4_VTRBD_I, (prDirMdPrm->u4Trbi << 16) | (prDirMdPrm->u4Trdi & 0xFFFF));
    vVDecWriteMP4AVCMV(u4VDecID, RW_AMV_MP4_VTRBD_I_PLUS_1, ((prDirMdPrm->u4Trbi + 1) << 16) | ((prDirMdPrm->u4Trdi + 1) & 0xFFFF));
    vVDecWriteMP4AVCMV(u4VDecID, RW_AMV_MP4_VTRBD_I_MINUS_1, ((prDirMdPrm->u4Trbi - 1) << 16) | ((prDirMdPrm->u4Trdi - 1) & 0xFFFF));
    ...
    if (i4Trd == 0)
    {
        vVDecWriteMP4AVCMV(u4VDecID, RW_AMV_MP4_VTRBD_RATIO, 0);
    }
    else
    {
        vVDecWriteMP4AVCMV(u4VDecID, RW_AMV_MP4_VTRBD_RATIO, (((i4Trb << 14) / i4Trd) << 16) | ((((i4Trd - i4Trb) << 14) / i4Trd) & 0xFFFF));
    }
    if (i4Trdi == 0)
    {
        vVDecWriteMP4AVCMV(u4VDecID, RW_AMV_MP4_VTRBD_I_RATIO, 0);
    }
    else
    {
        vVDecWriteMP4AVCMV(u4VDecID, RW_AMV_MP4_VTRBD_I_RATIO, (((i4Trbi << 14) / i4Trdi) << 16) | ((((i4Trdi - i4Trbi) << 14) / i4Trdi) & 0xFFFF));
    }
    if (i4Trdi == -1)
    {
        vVDecWriteMP4AVCMV(u4VDecID, RW_AMV_MP4_VTRBD_I_RATIO_2, 0);
    }
    else
    {
        vVDecWriteMP4AVCMV(u4VDecID, RW_AMV_MP4_VTRBD_I_RATIO_2, ((((i4Trbi + 1) << 14) / (i4Trdi + 1)) << 16) | ((((i4Trdi - i4Trbi) << 14) / (i4Trdi + 1)) & 0xFFFF));
    }
    if (1 == i4Trdi)
    {
        vVDecWriteMP4AVCMV(u4VDecID, RW_AMV_MP4_VTRBD_I_RATIO_3, 0);
    }
    else
    {
        vVDecWriteMP4AVCMV(u4VDecID, RW_AMV_MP4_VTRBD_I_RATIO_3, ((((i4Trbi - 1) << 14) / (i4Trdi - 1)) << 16) | ((((i4Trdi - i4Trbi) << 14) / (i4Trdi - 1)) & 0xFFFF));
    }
#endif
    // CCJu's
    ...
    if (_u4CodecVer[u4VDecID] == VDEC_DIVX3)
    {
        vVDecWriteMC(u4VDecID, RW_MC_GMC_C_MV, ((prGmcPrm->i4GmcYMvX << 15) & 0xFFFF0000) | ((prGmcPrm->i4GmcYMvY >> 1) & 0xffff)); // DIVX mode
    }
    else if ((_u4CodecVer[u4VDecID] == VDEC_MPEG4) || (_u4CodecVer[u4VDecID] == VDEC_H263) || (_u4CodecVer[u4VDecID] == VDEC_S263))
    {
        if (bMode_Divx[u4VDecID])
        {
            vVDecWriteMC(u4VDecID, RW_MC_GMC_C_MV, ((prGmcPrm->i4GmcYMvX << 15) & 0xFFFF0000) | ((prGmcPrm->i4GmcYMvY >> 1) & 0xffff)); // DIVX mode
...
#if (MPEG4_6589_SUPPORT)
    //6589NEW 4.2
    u4RegVal1 = u4VDecReadMP4AVCMV(u4VDecID, RW_AMV_MP4_COL_IVOP) & (~0x1);
    if (prMp4Prm->ucVopCdTp == VCT_B)
    {
        u4RegVal1 |= prVopPrm->ucBRefCdTp == VCT_I ? 0x1 : 0x0;
    }
    vVDecWriteMP4AVCMV(u4VDecID, RW_AMV_MP4_COL_IVOP, u4RegVal1);

    //6589NEW 4.3
    u4RegVal1 = u4VDecReadMP4AVCMV(u4VDecID, RW_AMV_MP4_TOP_FIELD_QUART_SAMPLE) & (~0x3);
    u4RegVal1 |= ((prVopPrm->fgTopFldFirst & 0x1) << 1) |
                 (prVolPrm->ucQuarterSample & 0x1);
    vVDecWriteMP4AVCMV(u4VDecID, RW_AMV_MP4_TOP_FIELD_QUART_SAMPLE, u4RegVal1);

    //6589NEW 4.4
    u4RegVal1 = u4VDecReadMP4AVCMV(u4VDecID, RW_AMV_MP4_GMC_Y_MV);
    if (1 == (prVolPrm->ucQuarterSample & 0x1))
    {
        vVDecWriteMP4AVCMV(u4VDecID, RW_AMV_MP4_GMC_Y_MV, (prGmcPrm->i4GmcYMvX << 16) | (prGmcPrm->i4GmcYMvY & 0xffff));
    }
    else
    {
        vVDecWriteMP4AVCMV(u4VDecID, RW_AMV_MP4_GMC_Y_MV, ((prGmcPrm->i4GmcYMvX >> 1) << 16) | ((prGmcPrm->i4GmcYMvY >> 1) & 0xffff));
    }
#endif
...
void vVLDMp4TriggerDec(UINT32 u4VDecID)
{
    ...
    if (bEnable_ErrorConcealment[u4VDecID])
    {
        UINT32 vld187;
...
//	vVDecWriteMC(u4VDecID, RW_MC_PREFETCH, u4VDecReadMC(u4VDecID, RW_MC_PREFETCH) & (~(0x1<<28)));//mc_651[28]=0
    vVDecWriteVLDTOP(u4VDecID, 0x120, (u4VDecReadVLDTOP(u4VDecID, 0x120) & (~(0x1))));  //vld_top_72[0]=0
...
//	vVDecWriteMC(u4VDecID, RW_MC_PREFETCH, u4VDecReadMC(u4VDecID, RW_MC_PREFETCH)|(1<<28));  //mc_651[28]=1
	vVDecWriteVLDTOP(u4VDecID, 0x120, (u4VDecReadVLDTOP(u4VDecID, 0x120) | (0x1)));	//vld_top_72[0]=1
...
//	vVDecWriteMC(u4VDecID, RW_MC_PREFETCH, u4VDecReadMC(u4VDecID, RW_MC_PREFETCH)|(1<<28));  //mc_651[28]=1
...
#endif
#endif
    if (bMode_VLD_Wrapper_Prefetch_1[u4VDecID])
    {
        //mode1: vld wrapper = bypass, vld prefetch = bypass, read burst = on.
        printk("MPEG4_VLD_WRAPPER_PREFETCH_MODE == 1\n");
	    vVDecWriteVLDTOP(u4VDecID, RW_VLD_TOP_PRED_SRAM_CFG, (u4VDecReadVLDTOP(u4VDecID, RW_VLD_TOP_PRED_SRAM_CFG) | (0x1<<30)));//vld_top_11[30]=1
    ...
    else if (bMode_VLD_Wrapper_Prefetch_2[u4VDecID])
    {
        //mode2: vld wrapper = no bypass, vld prefetch = bypass, read burst = off.
        printk("MPEG4_VLD_WRAPPER_PREFETCH_MODE == 2\n");
	    vVDecWriteVLDTOP(u4VDecID, RW_VLD_TOP_PRED_SRAM_CFG, (u4VDecReadVLDTOP(u4VDecID, RW_VLD_TOP_PRED_SRAM_CFG) & (~(0x1<<30))));//vld_top_11[30]=0
    ...
    {
        //default setting:
        printk("MPEG4_VLD_WRAPPER_PREFETCH_MODE default setting\n");
        vVDecWriteVLDTOP(u4VDecID, RW_VLD_TOP_PRED_SRAM_CFG, (u4VDecReadVLDTOP(u4VDecID, RW_VLD_TOP_PRED_SRAM_CFG) & (~(0x1<<30))));
        //	vVDecWriteMC(u4VDecID, RW_MC_PREFETCH, u4VDecReadMC(u4VDecID, RW_MC_PREFETCH) & (~(0x1<<28)));//mc_651[28]=0
        vVDecWriteVLDTOP(u4VDecID, 0x120, (u4VDecReadVLDTOP(u4VDecID, 0x120) & (~(0x1))));  //vld_top_72[0]=0
	    vVDecWriteVLDTOP(u4VDecID, RW_VLD_TOP_PRED_MODE, (u4VDecReadVLDTOP(u4VDecID, RW_VLD_TOP_PRED_MODE) & (~(0x3<<4)))); //vld_top_16[5:4]=2d'0
...
//#if (MPEG4_6582_SUPPORT || H263_USE_SORENSON)   // if sorenson263, remove this option
    if (_u4CodecVer[u4VDecID] == VDEC_S263)
    {
                       ...
                       UCHAR ucDataPartitioned)
{
    ...
    //6589NEW 4.1
    vVDecWriteMP4AVCMV(u4VDecID, RW_AMV_MP4_MV_DIRECT_SA, ((u4AbsDramANc(prMp4Prm->rMpeg4WorkBufSa.u4MvDirectSa) >> 4) & 0x0FFFFFFF));
#endif
...
void vVLDDx3DecPrmProc(UINT32 u4VDecID, VDEC_INFO_DEC_PRM_T *prDecPrm)
{
    ...
    //6589NEW 4.2 DIVX3
    vVDecWriteMP4AVCMV(u4VDecID, RW_AMV_MP4_COL_IVOP, u4VDecReadMP4AVCMV(u4VDecID, RW_AMV_MP4_COL_IVOP) & (~0x1));

    //6589NEW 4.3 DIVX3
    vVDecWriteMP4AVCMV(u4VDecID, RW_AMV_MP4_TOP_FIELD_QUART_SAMPLE, u4VDecReadMP4AVCMV(u4VDecID, RW_AMV_MP4_TOP_FIELD_QUART_SAMPLE) & (~0x3));

    //6589NEW 4.4 DIVX3
    vVDecWriteMP4AVCMV(u4VDecID, RW_AMV_MP4_GMC_Y_MV, 0);
#endif
...
void vVDecMpegCommSetting(UINT32 u4VDecID, VDEC_INFO_DEC_PRM_T *prDecPrm)
{
    ...
    if (_u4CodecVer[u4VDecID] == VDEC_MPEG4 || _u4CodecVer[u4VDecID] == VDEC_H263 || _u4CodecVer[u4VDecID] == VDEC_DIVX3 || _u4CodecVer[u4VDecID] == VDEC_S263)
    {
        ...
        {
            vVDecWriteMC(u4VDecID, 0x920, (u4VDecReadMC(u4VDecID, 0x920) | 0x01000000));
        }
    }
    else
    {
        if(bMode_FieldCompact[u4VDecID]==TRUE)
        {
    ...
    if (prMpegDecPrm->rMpegPpInfo.fgPpEnable)
    {
        ...
        if (_u4CodecVer[u4VDecID] == VDEC_MPEG4 || _u4CodecVer[u4VDecID] == VDEC_H263 || _u4CodecVer[u4VDecID] == VDEC_DIVX3 || _u4CodecVer[u4VDecID] == VDEC_S263)
        {
            if (bEnable_UFO[u4VDecID])
            {
                ...
                vVDecWriteMC(u4VDecID, RW_MC_PP_ENABLE, 1); //MC#136 [0]  ' 1  turn on PP out

                vVDecWriteMC(u4VDecID, RW_MC_PP_Y_ADDR, u4AbsDramANc(prMpegDecPrm->rMpegPpInfo.u4PpYBufSa) >> 9);
                vVDecWriteMC(u4VDecID, RW_MC_PP_C_ADDR, u4AbsDramANc(prMpegDecPrm->rMpegPpInfo.u4PpYBufSa+prDecPrm->u4PIC_SIZE_Y_BS) >> 8);
                vVDecWriteUFO(u4VDecID, 33*4, u4AbsDramANc(prMpegDecPrm->rMpegPpInfo.u4PpYBufSa) >> 9);
                vVDecWriteUFO(u4VDecID, 34*4, u4AbsDramANc(prMpegDecPrm->rMpegPpInfo.u4PpYBufSa+prDecPrm->u4PIC_SIZE_Y_BS) >> 8);

                vVDecWriteMC(u4VDecID, RW_MC_PP_MB_WIDTH, (prDecPrm->u4PicW + 15) >> 4);


                vVDecWriteMC(u4VDecID, 700*4, u4PIC_W_H);//700*4 = 0xAF0
                //vVDecWriteMC(u4VDecID, 664*4, (u4VDecReadMC(u4VDecID, 664*4)|0x11));
                //vVDecWriteMC(u4VDecID, 664*4, 0x11);//664*4 = 0xA60 //set ufo_en_flag =0x11
                vVDecWriteMC(u4VDecID, 664*4, 1);//664*4 = 0xA60 //set ufo_en_flag =1

                vVDecWriteUFO(u4VDecID,35*4,1);
                //for PP out
                vVDecWriteMC(u4VDecID, 698*4, u4AbsDramANc(prMpegDecPrm->rMpegPpInfo.u4PpYBufSa+prDecPrm->u4PIC_SIZE_BS));//698*4 = 0xAE8
                vVDecWriteMC(u4VDecID, 699*4, u4AbsDramANc(prMpegDecPrm->rMpegPpInfo.u4PpYBufSa+prDecPrm->u4PIC_SIZE_BS+prDecPrm->u4UFO_LEN_SIZE_Y));//699*4 = 0xAEC

                vVDecWriteUFO(u4VDecID, 31*4, u4AbsDramANc(prMpegDecPrm->rMpegPpInfo.u4PpYBufSa+prDecPrm->u4PIC_SIZE_BS));//698*4 = 0xAE8
                vVDecWriteUFO(u4VDecID, 32*4, u4AbsDramANc(prMpegDecPrm->rMpegPpInfo.u4PpYBufSa+prDecPrm->u4PIC_SIZE_BS+prDecPrm->u4UFO_LEN_SIZE_Y));//699*4 = 0xAEC
                //for MC(UFO DEC)
                ...
                memset(prMpegDecPrm->rMpegPpInfo.u4PpYBufSa, 0 ,prMpegDecPrm->u4DramPicArea);
            }
            else
            {
    ...
    else
    {
        ...
        if (!bEnable_UFO[u4VDecID])
        {
            vVDecWriteUFO(u4VDecID,35*4,0);
            vVDecWriteMC(u4VDecID, 664*4, 0);//664*4 = 0xA60 //set ufo_en_flag =1
        }
    ...
    if(bEnable_SARNOFF_ON[u4VDecID]==TRUE)
    {
...
void vVLDSetBRefCoLocI(UINT32 u4VDecID, BOOL fgIVop)
{
    ...
    if (fgIVop)
    {
        u4RegValue = u4VDecReadMP4AVCMV(u4VDecID, RW_AMV_MP4_COL_IVOP);
        vVDecWriteMP4AVCMV(u4VDecID, RW_AMV_MP4_COL_IVOP, u4RegValue | 1);
    }
    else
    {
        u4RegValue = u4VDecReadMP4AVCMV(u4VDecID, RW_AMV_MP4_COL_IVOP);
        vVDecWriteMP4AVCMV(u4VDecID, RW_AMV_MP4_COL_IVOP, u4RegValue & ~0x1);
    }
}
...
void VDecDumpMP4Register(UINT32 u4VDecID)
{
    ...
    if (!bEnable_ErrorConcealment[u4VDecID])
    {
        ...
        for (i = 0; i < 256; i++)
        {
            u4Val = u4VDecReadMP4AVCMV(0, i * 4);
        }
