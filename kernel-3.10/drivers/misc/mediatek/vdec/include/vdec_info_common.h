...
#else
#define FILELIST_SA 0x50000000 //0xe6000000 //0xB0000000 //0x44700000//0x4ab00000 //0x9A000000//0x05000000 //0x08000000
#endif
#endif
...
//#define HEVC_DUMP_PIC_BITSTREAM   // dump range: after SC to decode done
#define HEVC_SDCARD_VFY
#define HEVC_VP_MODE

//#define HEVC_MULTICORE_HW_IP    //"mediatek,VDEC" VA_VDEC_BASE reg = <0x16000000 0x40000>;  if not define: VA_VDEC_BASE reg = <0x16020000 0x10000>
