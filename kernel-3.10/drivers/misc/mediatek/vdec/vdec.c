...
static const UCHAR *g_pu1AllocSA = 0x50000000; //0xeda00000; //0xe6000000; //0x90000000; //0x88000000; //0x05000000;
...
#else
#if VDEC_MVC_SUPPORT
            MPV_thread = kthread_run(vVDecVerifyThread, param, "Vdec_thread");
#else
