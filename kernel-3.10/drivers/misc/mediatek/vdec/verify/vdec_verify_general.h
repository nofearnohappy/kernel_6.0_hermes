...
//#define USB_IO_ENABLE // using USB instead of SATA
...
#define VDEC_MPEG4_UFO  FALSE  //UFO mode for MPEG4
#define VDEC_UFO_ENABLE FALSE //UFO mode for MPEG12
...
#define MPEG2_FORCE_DUMP_TO_ONE_YUV
#define MPEG2_CHECK_NOHANG_ONLY 0
#define MPEG2_LOG_CRC_FROMHW 0
