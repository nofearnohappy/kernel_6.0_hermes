...
#else
#define V_FIFO_SZ 0x02000000//0x05000000 //0x1000000    //HEVC   //VC1 0x0BA00000 //MPEG4 0x02000000 (mpeg4 4k2k UFO)
#endif
#endif
...
#else
#define PIC_Y_SZ          (4096*3072) *2
#define PIC_C_SZ          (4096*3072 / 2) *2
#endif
#endif
...
#else
#define DEC_PP_Y_SZ      (4096*3072) *2
#define DEC_PP_C_SZ      (4096*3072/2) *2
#endif
...
// 6589NEW 1.1
#define DCAC_SZ           ((((4096 / 16) * 8) * 128) / 8) // (MBx * 8 * 128) bits = (MBx * 128) bytes = 15360
...
#define DATA_PARTITION_SZ   ((2 * (4096 / 16) * (3072 / 16) * 128) / 8) // (2 * MBx * MBy * 128) bits
// 6589
//#define NOT_CODED_SZ        (((((1920 / 16) * (1088 / 16) + 127) >> 7) << 7) / 8) // ((((1 * MBx * MBy) + 127) >> 7) << 7) bits = 1024 bytes
#define NOT_CODED_SZ        (((((4096 / 16) * (3072 / 16) + 127) >> 7) << 7) / 8) // ((((1 * MBx * MBy) + 127) >> 7) << 7) bits
// 6582
...
#define MV_DIRECT_SZ        (((4096 / 16) * (3072 / 16) * 128) / 8) // (MBx * MBy) * 128 bit
