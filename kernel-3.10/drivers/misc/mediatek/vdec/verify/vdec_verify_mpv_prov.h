...
extern char strVideoFileName[255];
...
extern BOOL bEnable_PP[2];
extern BOOL bEnable_UFO[2];
extern BOOL bEnable_AVC_UFO_NEW_TEST_VIDEO[2];
extern BOOL bEnable_ErrorConcealment[2];
extern BOOL bEnable_DDR4[2];
extern BOOL bEnable_SARNOFF_ON[2];
extern BOOL bMode_FieldCompact[2];
extern BOOL bMode_VP[2];
extern BOOL bGoldenCompare_CRC[2];
extern BOOL bGoldenCompare_Bitrue[2];
extern BOOL bDecode_YUVdump[2];
extern BOOL bMode_VLD_Wrapper_Prefetch_1[2];
extern BOOL bMode_VLD_Wrapper_Prefetch_2[2];
extern BOOL bMode_Divx[2];
extern BOOL bMode_10bit[2];
