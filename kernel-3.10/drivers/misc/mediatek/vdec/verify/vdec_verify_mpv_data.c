...
char strVideoFileName[255];

BOOL bEnable_PP[2];
BOOL bEnable_UFO[2];
BOOL bEnable_AVC_UFO_NEW_TEST_VIDEO[2]; // AVC: new data source for UFO 8bits
BOOL bEnable_ErrorConcealment[2];
BOOL bEnable_DDR4[2];
BOOL bEnable_SARNOFF_ON[2];

BOOL bMode_FieldCompact[2];
BOOL bMode_VP[2];
BOOL bMode_VLD_Wrapper_Prefetch_1[2];
BOOL bMode_VLD_Wrapper_Prefetch_2[2];
BOOL bGoldenCompare_CRC[2];
BOOL bGoldenCompare_Bitrue[2];
BOOL bDecode_YUVdump[2];
BOOL bMode_Divx[2];
BOOL bMode_10bit[2];
BOOL bMode_MCORE[2];
...
char _FileList_Rec[2][100] = {"\\\\emu264\\f\\ChkFolder\\8530_filelist_rec_h264.txt", "\\\\emu264\\f\\ChkFolder\\8530_filelist_rec_h264_1.txt"};
    ...
    char _FileList[2][100] = {"/mnt/sdcard/h264_list.txt", "/mnt/sdcard1/h264_list.txt"};
#else
    char _FileList[2][100] = {"D:\\TY\\h264_list.txt\0", "D:\\TY\\h264_list.txt\0"};
#endif
#else
...
char _FileList[2][100] = {"/mnt/sdcard/test.list", "/mnt/sdcard/test.list"};
