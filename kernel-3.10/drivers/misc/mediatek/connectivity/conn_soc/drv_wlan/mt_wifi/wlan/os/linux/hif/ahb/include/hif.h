...
#define MTK_CHIP_ID_6755    0x6755
	...
	UINT_8 *WIFIRegBaseAddr; /* WIFI CR register base */
...
#define WIFI_CR_REG_BASE			0x18B40000
#define WIFI_CR_REG_LENGTH			0x0100
...
/* PIO mode WIFI register read/write */
#define HIF_WIFI_READL(_hif, _addr)          \
	    readl((volatile UINT_32 *)((_hif)->WIFIRegBaseAddr + _addr))

#define HIF_WIFI_WRITEL(_hif, _addr, _val)   \
	    writel(_val, ((volatile UINT_32 *)((_hif)->WIFIRegBaseAddr + _addr)))
/*******************************************************************************
