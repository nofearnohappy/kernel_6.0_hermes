...
MFC_STATUS MFC_Open(MFC_HANDLE *handle,
		    ...
		    unsigned int fb_height, unsigned int fb_bpp, unsigned int fg_color, unsigned int bg_color)
{
...
MFC_STATUS MFC_Open_Ex(MFC_HANDLE *handle,
		       ...
		       unsigned int fb_pitch, unsigned int fb_bpp, unsigned int fg_color, unsigned int bg_color)
{
